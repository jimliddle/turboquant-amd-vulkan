                ...
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_memory_hybrid_iswa(
                            ...
                            /* attn_codec        */ params.kv_cache_codec,
                            /* attn_tq_runtime   */ params.turboquant_runtime,
                            /* attn_tq_group     */ params.turboquant_group_size,
                            /* attn_tq_res_bits  */ params.turboquant_residual_bits,
                            /* attn_tq_qjl       */ params.turboquant_qjl,
                            /* attn_tq_fallback  */ params.turboquant_allow_fallback,
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_kv_cache_iswa(
                                *this,
                                params.type_k,
                                params.type_v,
                                params.kv_cache_codec,
                                params.turboquant_runtime,
                                params.turboquant_group_size,
                                params.turboquant_residual_bits,
                                params.turboquant_qjl,
                                params.turboquant_allow_fallback,
                                !cparams.flash_attn,
                                cparams.offload_kqv,
                                params.swa_full,
                                cparams.kv_unified,
