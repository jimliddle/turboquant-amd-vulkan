...
The below is only a high level summary of the results, a full benchmark doc is in the docs section of the repository [here](https://github.com/jimliddle/turboquant-amd-vulkan/blob/main/Docs/turboquant-benchmarks.md).
